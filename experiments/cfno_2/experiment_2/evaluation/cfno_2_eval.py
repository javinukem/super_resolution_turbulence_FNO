...
for model_folder in subfolders:
    ...
    while current_batch_size >= min_batch_size:
        try:
            ...
            break  # success, exit batch size reduction loop
            ...
            if "out of memory" in str(e).lower():
                ...
                raise  # if it's a different runtime error, raise it

df = pd.DataFrame(results)
df.to_csv(os.path.join("..", "fno_eval_results.csv"), index=False)
print("Results saved to fno_eval_results.csv")
